...
mod avx2_tests{
    ...
    fn test_is_full_fn(){
        ...
        let _result = w_ring.push_avx2(msg);
    ...
    #[test]
    fn test_push_avx2_pop_avx2_twice_ring_buffer(){
        let mut buffer: Vec<u8> = vec![0;TEST_SHM_SIZE];
        let mut r_ring = RingbufRo::new(TEST_SHM_SIZE, buffer.as_mut_ptr());
        let mut w_ring = RingbufRw::new(TEST_SHM_SIZE, buffer.as_mut_ptr());

        let msg = b"AAAABB";
        println!("push_avx2 {:x?}", &msg);
        let result = w_ring.push_avx2(msg);
        println!("{w_ring}");
        assert_eq!(14, result);
        ...
        let mut buffer = [0;6];
        println!("pop_avx2 {:x?}", &msg);
        let sz = r_ring.pop_avx2(&mut buffer);
        println!("{r_ring}");
    ...
    #[test]
    fn test_push_avx2_push_avx2_full_pop_avx2_pop_avx2(){
        let mut buffer: Vec<u8> = vec![0;TEST_SHM_SIZE];
        let mut r_ring = RingbufRo::new(TEST_SHM_SIZE, buffer.as_mut_ptr());
        let mut w_ring = RingbufRw::new(TEST_SHM_SIZE, buffer.as_mut_ptr());
        ...
        let mut buffer = [0;10];
        let _result = r_ring.pop_avx2(&mut buffer);
        println!("pop_avx2 {:x?}", &buffer);
        println!("{r_ring}");
    ...
    #[test]
    fn test_push_avx2_msg_when_full(){
        let mut buffer: Vec<u8> = vec![0;TEST_SHM_SIZE];
        let mut w_ring = RingbufRw::new(TEST_SHM_SIZE, buffer.as_mut_ptr());
    ...
    #[test]
    fn test_pop_avx2_msg_when_empty(){
        let mut buffer: Vec<u8> = vec![0;TEST_SHM_SIZE];
        let mut r_ring = RingbufRo::new(TEST_SHM_SIZE, buffer.as_mut_ptr());

        let mut buffer = [0;0];
        let result = r_ring.pop_avx2(&mut buffer);
        println!("pop_avx2 {:x?}", &buffer);
        println!("{r_ring}");
        assert_eq!(0, result);
    }
